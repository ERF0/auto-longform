<p align="left">
    <h1 align="left">AUTO LONG-FORM CONTENT</h1>
</p>
<p align="left">
	<img src="https://img.shields.io/github/license/marvinvr/auto-long-form-content?style=flat-square&logo=opensourceinitiative&logoColor=white&color=0080ff" alt="license">
	<img src="https://img.shields.io/github/last-commit/marvinvr/auto-long-form-content?style=flat-square&logo=git&logoColor=white&color=0080ff" alt="last-commit">
	<img src="https://img.shields.io/github/languages/top/marvinvr/auto-long-form-content?style=flat-square&color=0080ff" alt="repo-top-language">
	<img src="https://img.shields.io/github/languages/count/marvinvr/auto-long-form-content?style=flat-square&color=0080ff" alt="repo-language-count">
<p>
<p align="left">
...
Auto Long-Form Content is an open-source project designed to automate the creation of rich, long-form videos for platforms like YouTube. Leveraging AI models and APIs, it helps generate outlines, narration, subtitles, and visual assets while handling rendering and optional uploads. With features like background music selection and parallel execution, Auto Long-Form Content keeps longer videos cohesive without manual stitching.
...
The YouTube channel below showcases the project in action, with examples of AI-assisted videos and uploads.
...
| requirements.txt     | Manages project dependencies such as OpenAI and FastAPI to facilitate AI video generation, processing, and uploading functionalities within the auto-long-form-content repository's ecosystem. The file ensures seamless integration of critical libraries for efficient execution of tasks. |
| environment.yml       | Defines dependencies and environment setup for Python project auto-long-form-content. Specifies required packages and their versions, ensuring compatibility and consistent development environment for the repository.                                                                      |
| Dockerfile                 | Builds a Docker container for auto-long-form-content project, setting up Python environment and executing necessary commands. Copies project files, installs dependencies, and initiates the main script within a Python virtual environment.                                                |
...
| docker-compose.yml | Orchestrates Docker containers for the auto-long-form-content service, configuring volumes and environment variables. Exposes port 8000 for external access.                                                                                                                                 |
...
| llm.py                   | Generates engaging video ideas, titles, and descriptions based on user topics. Utilizes OpenAI-compatible language models to draft conversational scripts suited for longer videos.                                                                                                  |
...
| audio.py               | Generates voiceovers and selects random background songs for videos using OpenAI API and local files. Provides functionalities for creating audio files and selecting music assets in the auto-long-form-content repository structure.                                                                 |
...
> 1. Clone the auto-long-form-content repository:
>
> ```console
> $ git clone https://github.com/marvinvr/auto-long-form-content
> ```
>
> 2. Change to the project directory:
>
> ```console
> $ cd auto-long-form-content
> ```
>
...
>
> Follow the instructions in the YouTube Data API documentation to create a project and obtain OAuth 2.0 credentials. Place your `client_secrets.json` file in the `./credentials` directory.
>
...
> Run auto-long-form-content using one of the following methods:
>
> **One-time execution:**
> ```console
...
- **Report Issues**: Submit bugs found or log feature requests for the `auto-long-form-content` project.
...
<p align="center">
      ...
      <img src="https://contrib.rocks/image?repo=marvinvr/auto-long-form-content">
